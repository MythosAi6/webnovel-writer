...
```bash
claude plugin marketplace add abro666/webnovel-writer --scope user
...
```bash
python -m pip install -r https://raw.githubusercontent.com/abro666/webnovel-writer/HEAD/requirements.txt
```
